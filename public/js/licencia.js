//Es igual que part1 js salvo una pequea correccion
...
$(document).on('ready', function() {
	...
	$('#submit').click(function(){
		...
		console.log("HHHHHOOOOOLLLLLLLLLAAAAA")
		var obj = 	{
						type: 'crear_licencia',
						clave: $('input[name="clave"]').val(),
						owner: $('input[name="owner"]').val(),
						descripcion: $('input[name="descripcion"]').val(),
						f_ini: $('input[name="f_ini"]').val(),
						f_fin: $('input[name="f_fin"]').val(),
						v: 1
					};
		if(obj.clave && obj.owner && obj.descripcion && obj.f_ini && obj.f_fin){
			console.log('Creando licencia, enviado', obj);
	...
	function showHomePanel(){
		...
		var part = window.location.pathname.substring(0,10);
